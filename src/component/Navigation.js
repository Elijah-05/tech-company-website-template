...
import navBarLogoDesktop from "../assets/images/addis-logo.png";
import navBarLogoMobile from "../assets/images/addis-icon.png";
  ...
  useEffect(() => {
    const handleScrollEvent = () => {
      if (pathname === "/" && window.scrollY > 500) {
        setDimNav(true);
      } else if (pathname !== "/" && window.scrollY > 350) {
        setDimNav(true);
