            ...
            <div className=" mt-3">
              ...
              <ul className="mt-6 mb-10">
                <li className=" flex items-center my-1">
                  <GiCheckMark className="mr-3" /> Lorem ipsum dolor sit
                </li>
                <li className=" flex items-center my-1">
                  <GiCheckMark className="mr-3" /> Lpsum dolor sit amet
                  consectetur.
                </li>
                <li className=" flex items-center my-1">
                  <GiCheckMark className="mr-3" /> Lorem ipsum dolor sit
                ...
                <li className=" flex items-center my-1">
                  <GiCheckMark className="mr-3" /> Lipsum dolor sit amet
                  consectetur.
                </li>
                <li className=" flex items-center my-1">
                  <GiCheckMark className="mr-3" /> Lorem ipsum dolor sit amet
                </li>
                <li className=" flex items-center my-1">
                  <GiCheckMark className="mr-3" /> Dolor ipsum dolor sit
                </li>
                <li className=" flex items-center my-1">
                  <GiCheckMark className="mr-3" /> Sit amet ipsum anet sita
                </li>
              </ul>
            </div>
